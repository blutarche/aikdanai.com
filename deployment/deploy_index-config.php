 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'AikdanaiSidhikosolJitladaSupreeyaporn');
/**
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/blutarche/aikdanai.com.git');
/**
 ...
 */
define('TARGET_DIR', '/var/www/dev.aikdanai.com/html/');
/**
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/tmp/aik-'.md5(REMOTE_REPOSITORY).'/');
/**
