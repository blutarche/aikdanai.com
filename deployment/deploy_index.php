 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'ThailandDemocracyNowadaysIsSoIntense');
/**
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/blutarche/intensifier.git');
/**
 ...
 * @var string
 */
if (!defined('BRANCH')) define('BRANCH', 'development');
/**
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/dev.aikdanai.com/html/intensifier/');
/**
